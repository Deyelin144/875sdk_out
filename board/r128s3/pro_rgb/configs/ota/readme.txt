...
1.ota-step-ab.fex, ota-subimgs-ab.cfg, sys_partition_ab.fex 这 3 个文件是 AB 系统用的

2.将 sys_partition_ab.fex 文件复制到 cconfigs 命令对应的目录，覆盖 sys_partition.fex
...
1.ota-step-recovery.fex, ota-subimgs-recovery.cfg, sys_partition_recovery.fex 这 3 个文件是 recovery 系统用的

2.将sys_partition_recovery.fex文件复制到 cconfigs 命令对应的目录，覆盖 sys_partition.fex
