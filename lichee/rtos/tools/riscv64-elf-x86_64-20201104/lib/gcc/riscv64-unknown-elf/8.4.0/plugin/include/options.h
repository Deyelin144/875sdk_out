...
#endif
#ifdef GENERATOR_FILE
extern int warn_dsp_const_overflow;
#else
  int x_warn_dsp_const_overflow;
#define warn_dsp_const_overflow global_options.x_warn_dsp_const_overflow
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wdsp_const_overflow = 220,             /* -Wdsp-const-overflow */
  ...
  OPT_m4k_opts = 1193,                       /* -m4k-opts */
  OPT_mabi_ = 1194,                          /* -mabi= */
  OPT_maddsl = 1195,                         /* -maddsl */
  OPT_maddsluw = 1196,                       /* -maddsluw */
  ...
  OPT_mdelete_vsetvl_zero = 1206,            /* -mdelete-vsetvl-zero */
  OPT_mdiv = 1207,                           /* -mdiv */
  OPT_mdse_losum = 1208,                     /* -mdse-losum */
  OPT_mexpand_split_imm = 1209,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1210,               /* -mexplicit-relocs */
  OPT_mext = 1211,                           /* -mext */
  OPT_mfclass = 1212,                        /* -mfclass */
  OPT_mfdiv = 1213,                          /* -mfdiv */
  OPT_mfldr = 1214,                          /* -mfldr */
  OPT_mfmvhw32 = 1215,                       /* -mfmvhw32 */
  OPT_mfp16 = 1216,                          /* -mfp16 */
  ...
  OPT_mldi = 1223,                           /* -mldi */
  OPT_mldr = 1224,                           /* -mldr */
  OPT_mmove_loop_vsetvl = 1225,              /* -mmove-loop-vsetvl */
  OPT_mmula = 1226,                          /* -mmula */
  ...
  OPT_mvlen_ = 1243,                         /* -mvlen= */
  OPT_mxor_combine = 1244,                   /* -mxor-combine */
  OPT_n = 1245,                              /* -n */
  ...
  OPT_static_pie = 1295,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1303,                      /* -std=c++2a */
  OPT_std_c__98 = 1304,                      /* -std=c++98 */
  OPT_std_c11 = 1305,                        /* -std=c11 */
  OPT_std_c17 = 1306,                        /* -std=c17 */
  /* OPT_std_c18 = 1307, */                  /* -std=c18 */
  /* OPT_std_c1x = 1308, */                  /* -std=c1x */
  /* OPT_std_c89 = 1309, */                  /* -std=c89 */
  OPT_std_c90 = 1310,                        /* -std=c90 */
  OPT_std_c99 = 1311,                        /* -std=c99 */
  /* OPT_std_c9x = 1312, */                  /* -std=c9x */
  OPT_std_f2003 = 1313,                      /* -std=f2003 */
  OPT_std_f2008 = 1314,                      /* -std=f2008 */
  OPT_std_f2008ts = 1315,                    /* -std=f2008ts */
  OPT_std_f2018 = 1316,                      /* -std=f2018 */
  OPT_std_f95 = 1317,                        /* -std=f95 */
  OPT_std_gnu = 1318,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1319, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1320, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1321,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1322,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1323,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1324, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1325, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1326,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1327,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1328,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1329,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1330, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1341, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1342, */         /* -std=iso9899:2018 */
