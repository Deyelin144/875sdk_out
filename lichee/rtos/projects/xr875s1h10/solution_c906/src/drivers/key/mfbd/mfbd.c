        ...
        if (_pbtn_group->is_btn_down_func(_pbtn->btn_info->btn_index) != 0)
        {
            ...
            else
            {
                ...
                if (_pbtn->state == 0)
                {
                    ...
                    {
                        _pbtn_group->btn_value_report(_pbtn->btn_info->btn_index, _pbtn->btn_info->btn_down_code);
                    }
                }
            }
        }
        else
        {
            ...
            else
            {
                if (_pbtn->state == 1)
                {
                    ...
                    {
                        _pbtn_group->btn_value_report(_pbtn->btn_info->btn_index, _pbtn->btn_info->btn_up_code);
                    }
                }
            }
        }
                    ...
                    if (_pbtn->btn_info->long_time != 0)
                    {
                        if (_pbtn->long_count < _pbtn->btn_info->long_time)
                        {
                            ...
                            if (_pbtn->long_count >= _pbtn->btn_info->long_time)
                            {
                                ...
                                {
                                    _pbtn_group->btn_value_report(_pbtn->btn_info->btn_index, _pbtn->btn_info->btn_long_code);
                                }
                                else
                                {
        ...
        if (_pbtn_group->is_btn_down_func(_pbtn->btn_info->btn_index) != 0)
        {
            ...
            else
            {
                ...
                if (_pbtn->state == 0)
                {
                    ...
                    {
                        _pbtn_group->btn_value_report(_pbtn->btn_info->btn_index, _pbtn->btn_info->btn_down_code[_pbtn->multiclick_state]);
                    }
                }
                else
                {
