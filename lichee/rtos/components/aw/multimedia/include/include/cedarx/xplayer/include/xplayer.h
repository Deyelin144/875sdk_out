...
int XPlayerSwitchCard(XPlayer* p, int card);

int XPlayerSoundControl(XPlayer* p, int cmd, void *para);
...
void XPlayerSetTaskPrio(unsigned prio);

unsigned XPlayerGetTaskPrio(void);
