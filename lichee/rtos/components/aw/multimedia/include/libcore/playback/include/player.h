...
//**
int PlayerSetSoundCard(Player* pl, int card);
int PlayerGetSoundCard(Player* pl);
int PlayerSwitchSoundCard(Player* pl, int card);
int PlayerSoundControl(Player* pl, int cmd, void *para);

int PlayerSetAudioSink(Player* pl, SoundCtrl* pAudioSink);
SoundCtrl *PlayerGetAudioSink(Player* pl);
