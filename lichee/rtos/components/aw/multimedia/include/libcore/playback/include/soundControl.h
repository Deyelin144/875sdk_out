...
*/
    ...
    /* default sound card range is 0 ~ 100 */
    /* The range of custom sound cards may be different,
        so we do not define the range in the header file */
    SOUND_CONTROL_SET_VOLUME,
    SOUND_CONTROL_GET_VOLUME,
}SoundCtrlCmd;
