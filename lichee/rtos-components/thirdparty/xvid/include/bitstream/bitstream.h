...
static void __inline BitstreamInit(Bitstream *const bs, void *const bitstream, uint32_t length)
{
    uint32_t tmp;
    size_t bitpos;
...
static uint32_t __inline BitstreamShowBits(Bitstream *const bs, const uint32_t bits)
{
...
static __inline uint32_t BitstreamNumBitsToByteAlign(Bitstream *bs)
{
...
static __inline uint32_t BitstreamShowBitsFromByteAlign(Bitstream *bs, int bits)
{
...
static uint32_t __inline BitstreamGetBits(Bitstream *const bs, const uint32_t n)
{
...
static void __inline BitstreamPutBit(Bitstream *const bs, const uint32_t bit)
{
    if (bit)
...
static void __inline BitstreamPutBits(Bitstream *const bs, const uint32_t value,
                                      const uint32_t size)
{
...
static void __inline BitstreamPadAlways(Bitstream *const bs)
{
    int bits = 8 - (bs->pos % 8);
    BitstreamPutBits(bs, stuffing_codes[bits - 1], bits);
}
