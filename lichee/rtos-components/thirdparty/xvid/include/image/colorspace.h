...
typedef void(packedFunc)(uint8_t *x_ptr, int x_stride, uint8_t *y_src, uint8_t *v_src,
...
typedef void(planarFunc)(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst, int y_dst_stride,
