...
static __inline uint32_t masked_sseh8_16bit(int16_t *const orig, int16_t *const rec,
...
typedef void(CheckFunc)(const int x, const int y, SearchData *const Data,
...
int xvid_me_SkipDecisionP(const IMAGE *current, const IMAGE *reference, const int x, const int y,
                          const uint32_t stride, const uint32_t iQuant);

#define iDiamondSize 2
typedef void MainSearchFunc(int x, int y, SearchData *const Data, int bDirection,
