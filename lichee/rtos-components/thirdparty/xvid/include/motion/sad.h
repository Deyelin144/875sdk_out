...
typedef uint32_t(sad16Func)(const uint8_t *const cur, const uint8_t *const ref,
...
typedef uint32_t(sad8Func)(const uint8_t *const cur, const uint8_t *const ref,
...
typedef uint32_t(sad16biFunc)(const uint8_t *const cur, const uint8_t *const ref1,
                              const uint8_t *const ref2, const uint32_t stride);
...
typedef uint32_t(sad8biFunc)(const uint8_t *const cur, const uint8_t *const ref1,
                             const uint8_t *const ref2, const uint32_t stride);
...
typedef uint32_t(dev16Func)(const uint8_t *const cur, const uint32_t stride);
typedef dev16Func *dev16FuncPtr;
extern dev16FuncPtr dev16;
dev16Func dev16_c;

typedef uint32_t(sad16vFunc)(const uint8_t *const cur, const uint8_t *const ref,
...
typedef uint32_t(sse8Func_16bit)(const int16_t *cur, const int16_t *ref, const uint32_t stride);
...
typedef uint32_t(sse8Func_8bit)(const uint8_t *cur, const uint8_t *ref, const uint32_t stride);
...
typedef uint32_t(sseh8Func_16bit)(const int16_t *cur, const int16_t *ref, uint16_t mask);
...
typedef uint32_t(blocksum8Func)(const uint8_t *cur, int stride, uint16_t sums[4],
                                uint32_t squares[4]);
...
static const int16_t Inv_iMask_Coeff[64] = {
    0,     155,   128,   328,   737,  2048,  3329,  4763,  184,   184,   251,   462,   865,
    4306,  4608,  3872,  251,   216,  328,   737,   2048,  4159,  6094,  4014,  251,   370,
    620,   1076,  3329,  9688,  8192, 4920,  415,   620,   1752,  4014,  5919,  15207, 13579,
    7589,  737,   1568,  3872,  5243, 8398,  13844, 16345, 10834, 3073,  5243,  7787,  9688,
    13579, 18741, 18433, 13057, 6636, 10834, 11552, 12294, 16056, 12800, 13579, 12545
};

static const uint16_t iCSF_Coeff[64] = {
    26353, 38331, 42164, 26353, 17568, 10541, 8268,  6912,  35137, 35137, 30117, 22192, 16217,
    7270,  7027,  7666,  30117, 32434, 26353, 17568, 10541, 7397,  6111,  7529,  30117, 24803,
    19166, 14539, 8268,  4846,  5271,  6801,  23425, 19166, 11396, 7529,  6201,  3868,  4094,
    5476,  17568, 12047, 7666,  6588,  5205,  4054,  3731,  4583,  8605,  6588,  5406,  4846,
    4094,  3485,  3514,  4175,  5856,  4583,  4438,  4302,  3765,  4216,  4094,  4259
};

static const uint16_t iCSF_Round[64] = { 1, 1, 1, 1, 2, 3, 4, 5, 1, 1, 1, 1, 2, 5, 5, 4,
                                         1, 1, 1, 2, 3, 4, 5, 4, 1, 1, 2, 2, 4, 7, 6, 5,
                                         1, 2, 3, 4, 5, 8, 8, 6, 2, 3, 4, 5, 6, 8, 9, 7,
                                         4, 5, 6, 7, 8, 9, 9, 8, 6, 7, 7, 8, 9, 8, 8, 8 };
