...
typedef void(TRANSFER_8TO16COPY)(int16_t *const dst, const uint8_t *const src, uint32_t stride);
...
typedef void(TRANSFER_16TO8COPY)(uint8_t *const dst, const int16_t *const src, uint32_t stride);
...
typedef void(TRANSFER_8TO16SUB)(int16_t *const dct, uint8_t *const cur, const uint8_t *ref,
...
typedef void(TRANSFER_8TO16SUBRO)(int16_t *const dct, const uint8_t *const cur, const uint8_t *ref,
                                  const uint32_t stride);
...
typedef void(TRANSFER_8TO16SUB2)(int16_t *const dct, uint8_t *const cur, const uint8_t *ref1,
                                 const uint8_t *ref2, const uint32_t stride);
...
typedef void(TRANSFER_8TO16SUB2RO)(int16_t *const dct, const uint8_t *const cur,
                                   const uint8_t *ref1, const uint8_t *ref2, const uint32_t stride);
...
typedef void(TRANSFER_16TO8ADD)(uint8_t *const dst, const int16_t *const src, uint32_t stride);
...
typedef void(TRANSFER8X8_COPY)(uint8_t *const dst, const uint8_t *const src, const uint32_t stride);
...
typedef void(TRANSFER8X4_COPY)(uint8_t *const dst, const uint8_t *const src, const uint32_t stride);
...
static __inline void transfer16x16_copy(uint8_t *const dst, const uint8_t *const src,
                                        const uint32_t stride)
{
...
static __inline void transfer32x32_copy(uint8_t *const dst, const uint8_t *const src,
                                        const uint32_t stride)
{
