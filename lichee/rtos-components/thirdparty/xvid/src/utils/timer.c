...
//     // count_frames = 0;
// #ifdef XVID_TIME_ENABLE
//     tim.dct = tim.quant = tim.idct = tim.iquant = tim.motion = tim.conv = tim.edges = tim.inter =
//             tim.interlacing = tim.trans = tim.trans = tim.coding = tim.global = tim.overall = 0;
// #endif
// }
