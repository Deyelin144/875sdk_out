...
// static __inline uint32_t MBDecideFieldDCT(int16_t data[6 * 64])
// {
...
// static __inline void MBiDCT(int16_t data[6 * 64], const uint8_t cbp)
// {
//     //start_timer();
//     if (cbp & (1 << (5 - 0)))
//         idct((short *const)&data[0 * 64]);
//     if (cbp & (1 << (5 - 1)))
//         idct((short *const)&data[1 * 64]);
//     if (cbp & (1 << (5 - 2)))
//         idct((short *const)&data[2 * 64]);
//     if (cbp & (1 << (5 - 3)))
//         idct((short *const)&data[3 * 64]);
//     if (cbp & (1 << (5 - 4)))
//         idct((short *const)&data[4 * 64]);
//     if (cbp & (1 << (5 - 5)))
//         idct((short *const)&data[5 * 64]);
//     //stop_idct_timer();
// }
...
// static int dct_quantize_trellis_c(int16_t *const Out, const int16_t *const In, int Q,
//                                   const uint16_t *const Zigzag, const uint16_t *const QuantMatrix,
//                                   int Non_Zero, int Sum, int Lambda_Mod, const uint32_t rel_var8,
//                                   const int Metric);
...
uint32_t MBFieldTest_c(int16_t data[6 * 64])
{
...
/* let's factorize: */
// static const uint8_t Code_Len0[64] = { 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len1[64] = { 20, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len2[64] = { 19, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len3[64] = { 18, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len4[64] = { 17, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len5[64] = { 16, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len6[64] = { 15, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len7[64] = { 13, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len8[64] = { 11, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len9[64] = { 12, 21, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                        30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len10[64] = { 12, 20, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len11[64] = { 12, 19, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len12[64] = { 11, 17, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len13[64] = { 11, 15, 21, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len14[64] = { 10, 12, 19, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len15[64] = { 10, 13, 17, 19, 21, 21, 21, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len16[64] = { 9,  12, 13, 18, 18, 19, 19, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len17[64] = { 8,  11, 13, 14, 14, 14, 15, 19, 19, 19, 21, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len18[64] = { 7,  9,  11, 11, 13, 13, 13, 15, 15, 15, 16, 22, 22,
//                                         22, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len19[64] = { 5,  7,  9,  10, 10, 11, 11, 11, 11, 11, 13, 14, 16,
//                                         17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 20, 20, 21,
//                                         21, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len20[64] = { 3,  4,  5,  6,  6,  6,  7,  7,  7,  7,  8,  8,  8,
//                                         9,  9,  10, 10, 10, 10, 10, 10, 10, 10, 12, 12, 13,
//                                         13, 12, 13, 14, 15, 15, 15, 16, 16, 16, 16, 17, 17,
//                                         17, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 21, 21,
//                                         22, 22, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };

/* a few more table for LAST table: */
// static const uint8_t Code_Len21[64] = { 13, 20, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len22[64] = { 12, 15, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len23[64] = { 10, 12, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17,
//                                         17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 19,
//                                         19, 19, 19, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21,
//                                         21, 21, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
//                                         30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30 };
// static const uint8_t Code_Len24[64] = { 5,  7,  7,  7,  7,  8,  8,  8,  8,  9,  9,  9,  9,
//                                         9,  9,  9,  9,  10, 10, 10, 10, 10, 10, 10, 10, 11,
//                                         11, 11, 11, 12, 12, 12, 12, 13, 13, 13, 13, 13, 13,
//                                         13, 13, 14, 16, 16, 16, 16, 17, 17, 17, 17, 18, 18,
//                                         18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19 };

// static const uint8_t *const B16_17_Code_Len[24] = {
//     /* levels [1..24] */
//     Code_Len20, Code_Len19, Code_Len18, Code_Len17, Code_Len16, Code_Len15, Code_Len14, Code_Len13,
//     Code_Len12, Code_Len11, Code_Len10, Code_Len9,  Code_Len8,  Code_Len7,  Code_Len6,  Code_Len5,
//     Code_Len4,  Code_Len3,  Code_Len3,  Code_Len2,  Code_Len2,  Code_Len1,  Code_Len1,  Code_Len1,
// };
...
// static const int Trellis_Lambda_Tabs[31] = { TL(1),  TL(2),  TL(3),  TL(4),  TL(5),  TL(6),  TL(7),
...
// static int __inline Find_Last(const int16_t *C, const uint16_t *Zigzag, int i)
// {
//     while (i >= 0)
//         if (C[Zigzag[i]])
//             return i;
...
// static __inline uint32_t calc_mseh(int16_t dQ, uint16_t mask, const int index, const int Lambda)
// {
...
//     const int Lambda = (Lambda_Mod * Trellis_Lambda_Tabs[Q - 1]) >> 6;
...
//         const unsigned int Dist0 =
//                 (Metric) ? (calc_mseh(AC, mask, Zigzag[i], Lambda)) : (Lambda * AC * AC);
...
static __inline uint32_t Evaluate_Cost(const int16_t *C, int Mult, int Bias, const uint16_t *Zigzag,
                                       int Max, int Lambda)
{
#if (DBG > 0)
    ...
    if (DBG == 1)
        printf(" Last:%2d/%2d Cost = [(Bits=%5.0d) + Lambda*(Dist=%6.0d) = %d ] >>12= %d ", Last,
               Max, Bits, Dist, Cost, Cost >> 12);
    return Cost;
...
static int dct_quantize_trellis_h263_c(int16_t *const Out, const int16_t *const In, int Q,
...
#if (DBG > 0)
    Last.Level = 0;
    Last.Run = -1; /* just initialize to smthg */
#endif
        ...
        if ((uint32_t)(Level1 + 1) < 3) /* very specialized loop for -1,0,+1 */
        {
            ...
            if (DBG == 1) {
                ...
                for (j = -1; j <= Non_Zero; ++j) {
                    if (j == Run_Start)
                        printf(" %3.0d|", Run_Costs[j] >> 12);
                    else if (j > Run_Start && j < i)
                        printf(" %3.0d|", Run_Costs[j] >> 12);
                    else if (j == i)
                        printf("(%3.0d)", Run_Costs[j] >> 12);
                    else
                ...
                printf("  Last:#%2d {%3.0d %2d %d}", Last_Node, Last_Cost >> 12, Last.Level,
                       Last.Run);
                printf(" AC:%3.0d Dist0:%3d Dist(%d)=%d", AC, Dist0 >> 12, Nodes[i].Level,
                       Cost0 >> 12);
                printf("\n");
            }
        } else /* "big" levels */
 ...
 */
            ...
            if (DBG == 1) {
                ...
                printf("  Last:#%2d {%3.0d %2d %d}", Last_Node, Last_Cost >> 12, Last.Level,
                       Last.Run);
                printf(" AC:%3.0d Dist0:%3d Dist(%2d):%3d Dist(%2d):%3d", AC, Dist0 >> 12, Level1,
                       Dist1 >> 12, Level2, Dist2 >> 12);
                printf("\n");
            }
        }
