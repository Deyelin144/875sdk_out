 ...
 */
void transfer_16to8copy_c(uint8_t *const dst, const int16_t *const src, uint32_t stride)
{
    int i, j;
    ...
    for (j = 0; j < 8; j++) {
        for (i = 0; i < 8; i++) {
            ...
            const uint8_t value =
                    (uint8_t)((pixel & ~255) ? (-pixel) >> (8 * sizeof(pixel) - 1) : pixel);
 ...
 *    DCT (16bit) = C - R
 */
void transfer_8to16sub_c(int16_t *const dct, uint8_t *const cur, const uint8_t *ref,
...
void transfer_8to16subro_c(int16_t *const dct, const uint8_t *const cur, const uint8_t *ref,
                           const uint32_t stride)
{
    int i, j;
 ...
 *    C   (8bit) = R
 */
void transfer_8to16sub2_c(int16_t *const dct, uint8_t *const cur, const uint8_t *ref1,
...
void transfer_8to16sub2ro_c(int16_t *const dct, const uint8_t *const cur, const uint8_t *ref1,
                            const uint8_t *ref2, const uint32_t stride)
{
    uint32_t i, j;
 ...
 */
void transfer_16to8add_c(uint8_t *const dst, const int16_t *const src, uint32_t stride)
{
    int i, j;
