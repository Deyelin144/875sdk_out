...
uint32_t sad16_c(const uint8_t *const cur, const uint8_t *const ref, const uint32_t stride,
...
uint32_t sad16bi_c(const uint8_t *const cur, const uint8_t *const ref1, const uint8_t *const ref2,
...
uint32_t sad8bi_c(const uint8_t *const cur, const uint8_t *const ref1, const uint8_t *const ref2,
                  const uint32_t stride)
{
    uint32_t sad = 0;
    uint32_t i, j;
...
uint32_t sad8_c(const uint8_t *const cur, const uint8_t *const ref, const uint32_t stride)
{
    uint32_t sad = 0;
    uint32_t j;
    uint8_t const *ptr_cur = cur;
...
uint32_t dev16_c(const uint8_t *const cur, const uint32_t stride)
{
    uint32_t mean = 0;
    uint32_t dev = 0;
    uint32_t i, j;
...
uint32_t sad16v_c(const uint8_t *const cur, const uint8_t *const ref, const uint32_t stride,
                  int32_t *sad)
{
...
uint32_t sad32v_c(const uint8_t *const cur, const uint8_t *const ref, const uint32_t stride,
                  int32_t *sad)
{
...
uint32_t mrsad16_c(const uint8_t *const cur, const uint8_t *const ref, const uint32_t stride,
                   const uint32_t best_sad)
{
    uint32_t sad = 0;
    int32_t mean = 0;
...
uint32_t sse8_16bit_c(const int16_t *b1, const int16_t *b2, const uint32_t stride)
{
    int i;
    int sse = 0;
...
uint32_t sse8_8bit_c(const uint8_t *b1, const uint8_t *b2, const uint32_t stride)
{
    int i;
    int sse = 0;
...
static const int16_t iMask_Coeff[64] = {
    0,     29788, 32767, 20479, 13653, 8192,  6425,  5372,  27306, 27306, 23405, 17246, 12603,
    5650,  5461,  5958,  23405, 25205, 20479, 13653, 8192,  5749,  4749,  5851,  23405, 19275,
    14894, 11299, 6425,  3766,  4096,  5285,  18204, 14894, 8856,  5851,  4819,  3006,  3181,
    4255,  13653, 9362,  5958,  5120,  4045,  3151,  2900,  3562,  6687,  5120,  4201,  3766,
    3181,  2708,  2730,  3244,  4551,  3562,  3449,  3344,  2926,  3277,  3181,  3310
};
...
uint32_t sseh8_16bit_c(const int16_t *cur, const int16_t *ref, uint16_t mask)
{
    int j, i;
    uint32_t mse_h = 0;
...
uint32_t blocksum8_c(const uint8_t *cur, int stride, uint16_t sums[4], uint32_t squares[4])
{
    int i, j;
    uint32_t sum = 0;
