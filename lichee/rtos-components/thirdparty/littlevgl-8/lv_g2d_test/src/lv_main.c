...
int lvgl_main(int argc, char *argv[]) {
    ...
    uint32_t gif_index = 2, bmp_index = 0, png_index = 2;
    char *gif_path[] = { 
			"A:/data/lv_g2d_test/240x320.gif",
            "A:/data/lv_g2d_test/313x235.gif",
            "A:/data/lv_g2d_test/no.gif" 
		};

	char *bmp_path[] = { 
			"A:/data/lv_g2d_test/512x352.bmp",
            "A:/data/lv_g2d_test/320_240.bmp",
            "A:/data/lv_g2d_test/no.bmp" 
		};

    char *png_path[] = { 
			"A:/data/lv_g2d_test/47x48.png",
