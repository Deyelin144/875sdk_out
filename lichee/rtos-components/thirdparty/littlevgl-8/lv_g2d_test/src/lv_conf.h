...
#if (LV_COLOR_DEPTH == 16) && defined(CONFIG_LVGL8_USE_SUNXIFB_G2D)
    #define GIF_DEC_WITHOUT_ALPHA
    #define PNG_DEC_WITHOUT_ALPHA
    #define BIN_DEC_WHOLE_ONCE
#endif
...
#ifdef PRESTO_RTOS
    #define LV_FS_STDIO_PATH "/data/"         /*Set the working directory. File/directory paths ill be appended to it.*/
#else
