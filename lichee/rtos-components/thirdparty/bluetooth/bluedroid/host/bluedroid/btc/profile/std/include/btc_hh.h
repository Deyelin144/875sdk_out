...
typedef struct {
    xr_hidh_connection_state_t dev_status;
    uint8_t dev_handle;
    BD_ADDR bd_addr;
    uint16_t attr_mask;
    uint8_t sub_class;
...
typedef union {
    ...
    struct set_protocol_arg {
        BD_ADDR bd_addr;
        xr_hidh_protocol_mode_t protocol_mode;
    } set_protocol;
    ...
    struct get_report_arg {
        BD_ADDR bd_addr;
        xr_hidh_report_type_t report_type;
        uint8_t report_id;
        int buffer_size;
    } get_report;
