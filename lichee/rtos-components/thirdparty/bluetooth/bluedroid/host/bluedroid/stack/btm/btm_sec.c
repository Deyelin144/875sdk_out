...
void btm_io_capabilities_req (UINT8 *p)
{
    ...
    */
...
#endif
    {
        ...
        /* Set bonding bit.
         * If local device initiated the pairing, should non-bonding -> genernal-bonding.
         * Otherwise, some device may connection failed, due to different auth requirements.
         */
        else {
            evt_data.auth_req = (BTM_AUTH_GB_BIT | (evt_data.auth_req & BTM_AUTH_YN_BIT));
        }
#endif
