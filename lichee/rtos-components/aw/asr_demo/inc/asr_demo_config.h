...
#define RPD_VAD_EOS_OFFSET          (RPD_VAD_SEND_SIZE)
#define RPD_VAD_EOS_SIZE            (sizeof(int))
#define RPD_VAD_EOS_SEND_SIZE                   (RPD_VAD_EOS_OFFSET + RPD_VAD_EOS_SIZE)
#define RPD_USE_SDK_OFFSET                      (RPD_VAD_EOS_SEND_SIZE)
#define RPD_USE_SDK_SIZE                        (sizeof(int))
#define RPD_USE_SDK_SEND_SIZE                   (RPD_USE_SDK_OFFSET + RPD_USE_SDK_SIZE)
#define RPD_WAKE_UP_OFFSET                      (RPD_USE_SDK_SEND_SIZE)
#define RPD_WAKE_UP_SIZE                        (sizeof(float))
#define RPD_WAKE_UP_SEND_SIZE                   (RPD_WAKE_UP_OFFSET + RPD_WAKE_UP_SIZE)
#define RPD_VAD_TOTAL_LEN                       (RPD_WAKE_UP_SEND_SIZE)
