...
static blink_ret_t blink_start(blink_param_t *param)
{
	blink_priv_t *priv = blink;
...
static blink_ret_t blink_wait(uint32_t timeout)
{
	blink_priv_t *priv = blink;
...
static blink_ret_t blink_get_result(blink_result_t *result)
{
	blink_priv_t *priv = blink;
	if (!priv || !result) {
...
static blink_ret_t blink_set_state(blink_state_t state)
{
	blink_priv_t *priv = blink;
...
static blink_ret_t blink_stop(void)
{
	blink_priv_t *priv = blink;
