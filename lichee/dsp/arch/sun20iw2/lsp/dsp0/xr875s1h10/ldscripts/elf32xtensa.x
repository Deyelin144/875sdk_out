/* This linker script generated from xt-genldscripts.tpp for LSP /home/hongjiasen/workplace/r128-dev-open/lichee/dsp/arch/sun20iw2/lsp/dsp0/xr875s1h10 */
/* Linker Script for default link */
MEMORY
{
  extra_mem_0_seg :                   	org = 0x0C0AE000, len = 0x660
  extra_mem_1_seg :                   	org = 0x0C0AE660, len = 0x9A0
  extra_mem_2_seg :                   	org = 0x0C0AF000, len = 0x17C
  extra_mem_3_seg :                   	org = 0x0C0AF17C, len = 0x20
  extra_mem_4_seg :                   	org = 0x0C0AF19C, len = 0x20
  extra_mem_5_seg :                   	org = 0x0C0AF1BC, len = 0x20
  extra_mem_6_seg :                   	org = 0x0C0AF1DC, len = 0x20
  extra_mem_7_seg :                   	org = 0x0C0AF1FC, len = 0x20
  extra_mem_8_seg :                   	org = 0x0C0AF21C, len = 0x20
  extra_mem_9_seg :                   	org = 0x0C0AF23C, len = 0x1C4
  extra_mem_10_seg :                  	org = 0x0C0AF402, len = 0x5FEBFE
}
...
_memmap_mem_extra_mem_start = 0xc0ae000;
_memmap_mem_extra_mem_end   = 0xc6ae000;

/*  Memory segment boundary addresses:  */
_memmap_seg_extra_mem_0_start = 0xc0ae000;
_memmap_seg_extra_mem_0_max   = 0xc0ae660;
_memmap_seg_extra_mem_1_start = 0xc0ae660;
_memmap_seg_extra_mem_1_max   = 0xc0af000;
_memmap_seg_extra_mem_2_start = 0xc0af000;
_memmap_seg_extra_mem_2_max   = 0xc0af17c;
_memmap_seg_extra_mem_3_start = 0xc0af17c;
_memmap_seg_extra_mem_3_max   = 0xc0af19c;
_memmap_seg_extra_mem_4_start = 0xc0af19c;
_memmap_seg_extra_mem_4_max   = 0xc0af1bc;
_memmap_seg_extra_mem_5_start = 0xc0af1bc;
_memmap_seg_extra_mem_5_max   = 0xc0af1dc;
_memmap_seg_extra_mem_6_start = 0xc0af1dc;
_memmap_seg_extra_mem_6_max   = 0xc0af1fc;
_memmap_seg_extra_mem_7_start = 0xc0af1fc;
_memmap_seg_extra_mem_7_max   = 0xc0af21c;
_memmap_seg_extra_mem_8_start = 0xc0af21c;
_memmap_seg_extra_mem_8_max   = 0xc0af23c;
_memmap_seg_extra_mem_9_start = 0xc0af23c;
_memmap_seg_extra_mem_9_max   = 0xc0af400;
_memmap_seg_extra_mem_10_start = 0xc0af402;
_memmap_seg_extra_mem_10_max   = 0xc6ae000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0xc0ae660);
PROVIDE(_memmap_vecbase_reset = 0xc0af000);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0xc6ae000);
  _heap_sentry = 0xc6ae000;
