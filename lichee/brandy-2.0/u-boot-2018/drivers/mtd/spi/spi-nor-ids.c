...
const struct flash_info spi_nor_ids[] = {
	...
	{ INFO("w25q64cv", 0xef4017, 0, 64 * 1024,  128,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB) //SPI_NOR_INDIVIDUAL_LOCK的宏会引起写保护,无法对flash进行擦写
	},
	...
	{ INFO("BY25Q256ES", 0x684019, 0, 64 * 1024,  512, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | SPI_NOR_4B_OPCODES) },
#endif
