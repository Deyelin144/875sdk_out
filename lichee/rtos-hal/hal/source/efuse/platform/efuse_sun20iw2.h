...
#define EFUSE_MAC_OFFSET			(132)
#define EFUSE_MAC_VERSION_OFFSET	(132)
#define EFUSE_MAC1_OFFSET			(134)   // wlan mac1 （芯片出厂烧写）
#define EFUSE_MAC2_OFFSET			(182)   // bt mac1 （芯片出厂烧写）
#define EFUSE_MAC_WIDTH				(98)
#define EFUSE_MAC_VERSION_WIDTH		(2)
#define EFUSE_MAC1_WIDTH			(48)
#define EFUSE_MAC2_WIDTH			(48)
#define EFUSE_MAC3_OFFSET           (1409)  // wlan mac2 （OEM自行烧写）
#define EFUSE_MAC4_OFFSET           (1458)  // bt mac2 （OEM自行烧写）
