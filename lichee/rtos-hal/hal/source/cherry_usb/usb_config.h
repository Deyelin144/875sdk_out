...
#define CONFIG_USBDEV_MSC_BLOCK_SIZE (512*10)
#endif
...
#ifndef HAL_THREAD_PRIORITY_MSC
#define HAL_THREAD_PRIORITY_MSC 17
#endif
...
#define CONFIG_USB_EHCI_HCCR_BASE       (0x40b43000)
#define CONFIG_USB_EHCI_HCOR_BASE       (0x40b43000 + 0x10)
