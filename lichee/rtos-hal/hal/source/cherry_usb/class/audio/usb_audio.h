...
#define AUDIO_AC_INPUT_TERMINAL_DESCRIPTOR_INIT(bTerminalID, wTerminalType, bNrChannels, wChannelConfig, iTerminal) \
    0x0C,                            /* bLength */                                                   \
    AUDIO_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */                                           \
    ...
    iTerminal,                       /* iChannelNames */                                             \
    iTerminal                        /* iTerminal */

#define AUDIO_AC_OUTPUT_TERMINAL_DESCRIPTOR_INIT(bTerminalID, wTerminalType, bSourceID, iTerminal) \
    0x09,                            /* bLength */                                  \
    AUDIO_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */                          \
